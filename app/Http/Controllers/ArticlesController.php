...
class ArticlesController extends Controller
{
    ...
    {
        $suppliers = Ambrand::withTrashed()->limit(10)->get();
        // dd($suppliers);
        $sections = AssemblyGroupNode::withTrashed()->limit(10)->get();
        $manufacturers = Manufacturer::withTrashed()->limit(10)->get();
        $keyValues = KeyValue::all();
        $languages = Language::select('lang')->distinct()->limit(10)->get();
        $article = Article::select()
            ->with('articleCriteria', function ($query) {
                $query->withTrashed()->limit(10);
            })
