...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::post('deleteRetailer',[RetailerController::class,'delete']);
	...
	Route::get('get_manufacturers_by_engine_type', [ManufacturerController::class,'getManufacturersByEngineType'])->name('get_manufacturers_by_engine_type');
	...
	Route::get('/show_form/{userid}/{formuserid}', 'FormController@show')->name('show_form');
	Route::get('/show_forms/{userid}', 'FormController@showForms')->name('show_forms');
