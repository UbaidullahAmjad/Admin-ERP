...
<body onload="myFunction()">
    ...
    <nav class="side-navbar">
        ...
        <ul id="side-main-menu" class="side-menu list-unstyled">
            ...
            @endif
            <li><a href="#archived" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span>{{ __('file.Archived') }}</span><span></a>
                <ul id="archived" class="collapse list-unstyled ">
                    <li id="maufacturer-list-menu" class="{{ $route == 'manufacturer.archive' ? 'active' : '' }}">
                    ...
                    <li id="modelseries-list-menu" class="{{ $route == 'article.archived' ? 'active' : '' }}"><a href="{{ route('article.archived') }}"><i class="dripicons-user-group"></i>
            ...
            <li id="retailers-list-menu" class="{{ $route == 'retailers.index' ? 'active' : '' }}"><a href="{{ route('retailers.index') }}"><i class="dripicons-user-group"></i>
                    {{ trans('file.Retailers') }}</a></li>
            <li id="form-list-menu" class="{{ $route == 'form.index' ? 'active' : '' }}"><a href="{{ route('form.index') }}"><i class="dripicons-list"></i>{{ trans('file.Forms') }}</a>
            </li>
            <li id="" class="{{ $route == 'chassis.index' ? 'active' : '' }}"><a href="{{ route('chassis.index') }}"><i class="dripicons-list"></i>
            ...
            <ul id="purchase" class="collapse list-unstyled ">
                ...
                <li id="purchase-import-menu"><a href="{{ url('purchases/purchase_by_csv') }}">{{ trans('file.Import Purchase By CSV') }}</a>
                </li>
                @endif
            </ul>
            </li>
            ...
            <ul id="transfer" class="collapse list-unstyled ">
                ...
                <li id="transfer-import-menu"><a href="{{ url('transfers/transfer_by_csv') }}">{{ trans('file.Import Transfer By CSV') }}</a>
                </li>
                @endif
            </ul>
            </li>
            ...
            <ul id="account" class="collapse list-unstyled ">
                ...
                <li id="money-transfer-menu"><a href="{{ route('money-transfers.index') }}">{{ trans('file.Money Transfer') }}</a>
                </li>
                @endif
                @if ($balance_sheet_permission_active)
                <li id="balance-sheet-menu"><a href="{{ route('accounts.balancesheet') }}">{{ trans('file.Balance Sheet') }}</a>
                </li>
                @endif
            ...
            <ul id="setting" class="collapse list-unstyled ">
                ...
                $discount_permission_active = DB::table('permissions')
                    ...
                    ->first();
                ?>
                @if ($role->id <= 2) <!-- <li id="role-menu"><a href="{{ route('role.index') }}">{{ trans('file.Role Permission') }}</a></li> -->
                    ...
                    @if (\Auth::user()->role_id <= 2) <!-- <li class="nav-item"><a href="{{ route('cashRegister.index') }}" data-toggle="tooltip" title="{{ trans('file.Cash Register List') }}"><i class="dripicons-archive"></i></a></li> -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="right-sidebar" id="notify">
                                ...
                                <li style="background-color: #F7F7F7" id="general-mail-setting-menu"><a href="{{ route('setting.generalmail') }}">{{ trans('file.General Mail Setting') }}</a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="right-sidebar" style="margin-top:;" id="notify">
                                ...
                                <li style="background-color: lightgrey"><a href="{{ url('user_show', [$noti->id, $noti->data['sender_id']]) }}">{{ Str::limit($noti->data['message'], 30) }}</a>
                                </li>
                                @elseif($noti->noti_type == 'formsubmission' && $noti->read_at == null)
                                <li style="background-color: lightgrey"><a href="{{ url('submitted_form_show', [$noti->id, $noti->data['sender_id']]) }}">{{ Str::limit($noti->data['message'], 30) }}</a>
                                </li>
                                @elseif($noti->noti_type == 'registration' && $noti->read_at != null)
                                <li style="background-color: #F7F7F7"><a href="{{ url('user_show', [$noti->id, $noti->data['sender_id']]) }}">{{ Str::limit($noti->data['message'], 30) }}</a>
                                </li>
                                @elseif($noti->noti_type == 'formsubmission' && $noti->read_at != null)
                                <li style="background-color: #F7F7F7"><a href="{{ url('submitted_form_show', [$noti->id, $noti->data['sender_id']]) }}">{{ Str::limit($noti->data['message'], 30) }}</a>
                                </li>
                                @endif
                                @endforeach
                            </ul>
    ...
    <script type="text/javascript">
        ...
        channel.bind('App\\Events\\FormApprove', function(data) {
            ...
            if (user_id == data.data.receiver) {
                ...
                <a href="/` + data.data.url + `/` + data.data.id + `/` + data.data.sender + `" class="btn btn-link">` +
                    notif + `</a>
                </li>
